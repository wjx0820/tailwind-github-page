	...
	<div class="text-gray-900 text-sm">
		...
		<div class="container mx-auto my-8 px-4 flex">
			...
			<div class="sidebar w-1/4">
				...
				vero culpa cupiditate explicabo dolore dolorum et minus pariatur
				consequuntur, eum accusantium amet doloremque maiores eaque voluptatum
				dolores? Accusantium perferendis voluptate doloremque, at iure hic odio
				aperiam! Facere consequatur libero animi quasi asperiores recusandae sit
				commodi iste, enim similique fugiat, error quod aperiam! Possimus alias
				quas aperiam perspiciatis consequuntur itaque, tempora, optio
				consequatur repellat harum, facilis at rerum accusantium tempore libero
				ducimus. Unde quasi dolore sequi quas! Quos facilis exercitationem non
				doloremque repellendus quia porro, consectetur veritatis sit aspernatur
				sint nostrum, repudiandae tempore soluta expedita error, quam
				reprehenderit natus cumque.
			</div>
			<!-- end sidebar -->
		</div>
		<footer
