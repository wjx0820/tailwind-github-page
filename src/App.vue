  ...
  <div class="text-gray-900 text-sm">
    ...
    <div class="repo-stats flex items-center justify-between px-8 py-4">
      <div class="flex">
        ...
        <div class="flex items-center text-xl ml-2">
          <a href="#" class="text-blue-700 hover:underline">vuejs</a>
          <span class="ml-1">/</span>
          <a href="#" class="text-blue-700 hover:underline font-semibold ml-1"
            >vue-next</a
          >
        </div>
      </div>
      <div class="flex space-x-2">
        <div class="flex text-xs">
          ...
          <a
            href="#"
            class="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1"
          >
            705
          </a>
        </div>
    ...
    <ul class="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
      <li class="font-semibold">
        <a
          href="#"
          class="flex items-center border-b-2 border-red-400 px-4 pb-3"
        >
          <svg
      ...
      <li>
        ...
        >
          ...
          <div class="text-xs rounded-lg bg-gray-300 px-2 ml-1">73</div>
        </a>
      </li>
      <li>
        <a
      ...
      <div class="file-explorer-container w-3/4 mr-8">
        <div class="branch-navigation flex items-center justify-between">
          ...
          <div class="flex items-center space-x-2">
            ...
            >
              <svg
                class="w-4 fill-current text-gray-200"
                viewBox="0 0 16 16"
                aria-hidden="true"
              >
                <path
        ...
        >
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate hidden lg:block">
              <a href="#" class="hover:underline hover:text-blue-600"
                >Disable lint rule for TODO comments</a
              >
            </div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate hidden lg:block">
              <a
                href="#"
                class="hover:underline hover:text-blue-600 truncate hidden lg:block"
                >Add new `plugin` and `plugin.withOptions` functions for
                creating plugins</a
              >
            </div>
        ...
        >
          ...
          <div>
            ...
            recusandae necessitatibus consectetur delectus soluta officia a?
            Dolores reprehenderit optio at esse cupiditate vel, corporis nam
            dolore fugiat voluptatum fugit dicta rerum quasi non? Perferendis
            iure ab consectetur quis quo modi, obcaecati recusandae cum
            aspernatur libero esse nam sunt nostrum, officiis sint deleniti
            expedita reprehenderit assumenda quaerat necessitatibus quam dolores
            distinctio voluptas. At natus accusantium placeat amet perspiciatis
            commodi! Maiores similique atque in nemo veniam optio necessitatibus
            nobis nulla. Deserunt voluptatem consequuntur, minima aliquam quia
            vero doloremque natus nihil debitis optio consectetur iusto aliquid
            rerum accusantium architecto numquam in iure modi enim voluptatum!
            Debitis asperiores eaque ab, aliquid vero placeat quam tempora sint
            odit explicabo perferendis vel consectetur quibusdam earum neque
            commodi ex. Reprehenderit obcaecati eum cumque ipsa corrupti amet,
            dolor enim aspernatur dolorem inventore tempore aperiam pariatur
            voluptatem placeat illo! Cum, delectus pariatur error atque labore
            impedit suscipit! Saepe et nemo perspiciatis nostrum, quis at
            deleniti sint sit sequi nisi, provident necessitatibus minus ab
            aperiam! Molestiae ullam accusamus ut, sapiente quidem veniam
            reiciendis veritatis asperiores suscipit. Ab dolor illo molestias,
            doloribus debitis illum voluptatem itaque tempora pariatur ducimus
            quas culpa numquam consequatur repellendus vero totam impedit
            reiciendis maiores est amet.
          </div>
        </div>
      ...
      <div class="sidebar w-1/4">
        <div class="about">
          ...
          >
            <a
              href="#"
              class="bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-full px-2 py-1 mt-2 mr-2"
              >vuejs</a
            >
            <a
              href="#"
          ...
          <a href="#" class="flex items-center space-x-2 mt-4 group">
            ...
            <span class="group-hover:text-blue-600">9.72</span>
            <span class="text-gray-600 group-hover:text-blue-600">MB</span>
          </a>
          <a href="#" class="flex items-center space-x-2 mt-4 group">
            <svg
              class="w-4 fill-current text-gray-600 group-hover:text-blue-600"
        ...
        <div class="releases border-t border-gray-400 mt-6 pt-6">
          <h4 class="text-base font-semibold flex items-center">
            <span>Releases</span>
            <div class="text-xs rounded-lg bg-gray-300 px-2 ml-1">52</div>
          </h4>

          <a href="#" class="flex items-start mt-4 group">
            <svg
              class="fill-current mt-1 w-4 text-green-500 group-hover:text-blue-500"
              mt="1"
              classes="flex-shrink-0"
              color="green"
              viewBox="0 0 16 16"
            ...
            <span class="ml-2">
              <span class="font-semibold group-hover:text-blue-600"
                >v3.0.0 One Piece</span
              >
              <span
                class="ml-1 text-xs border border-green-500 text-green-600 rounded-full font-semibold px-2 inline-block"
              >
                Latest
              </span>
        ...
        <div class="used-by border-t border-gray-400 mt-6 pt-6">
          ...
          <div class="mt-4">
            <a href="#" class="flex items-center -space-x-2">
              <img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/antonyzotov/128.jpg"
                alt="avatar"
              ...
              />
              <img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/pcridesagain/128.jpg"
                alt="avatar"
                class="w-8 border-2 border-white rounded-full"
              />
              <img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/davidhemphill/128.jpg"
                alt="avatar"
                class="w-8 border-2 border-white rounded-full"
              />
              <img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/abdots/128.jpg"
                class="w-8 rounded-full border-2 border-white"
                alt="avatar"
              />
              <img
              ...
              />
              <img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/runningskull/128.jpg"
                class="w-8 rounded-full border-2 border-white"
                alt="avatar"
              />
              <span
        ...
        <div class="contributors border-t border-gray-400 mt-6 pt-6">
          <h4 class="text-base font-semibold flex items-center">
            ...
            <div class="text-xs rounded-lg bg-gray-300 px-2 ml-1">188</div>
          </h4>
          <div class="flex items-center flex-wrap mt-2">
            ...
            <a href="#"
              ><img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/byryan/128.jpg"
                alt="avatar"
                class="w-8 rounded-full mr-2 mt-2"
            /></a>
            <a href="#"
            ...
            <a href="#"
              ><img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/herkulano/128.jpg"
                alt="avatar"
                class="w-8 rounded-full mr-2 mt-2"
            /></a>
            <a href="#"
              ><img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/jlsolerdeltoro/128.jpg"
                alt="avatar"
                class="w-8 rounded-full mr-2 mt-2"
            /></a>
            <a href="#"
              ><img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/kostaspt/128.jpg"
                alt="avatar"
                class="w-8 rounded-full mr-2 mt-2"
            /></a>
            <a href="#"
            ...
            <a href="#"
              ><img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/stan/128.jpg"
                alt="avatar"
                class="w-8 rounded-full mr-2 mt-2"
            /></a>
            <a href="#"
              ><img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/sandywoodruff/128.jpg"
                alt="avatar"
                class="w-8 rounded-full mr-2 mt-2"
            /></a>
            <a href="#"
              ><img
                src="https://s3.amazonaws.com/uifaces/faces/twitter/chacky14/128.jpg"
                alt="avatar"
                class="w-8 rounded-full mr-2 mt-2"
            /></a>
          </div>
        ...
        <div class="languages border-t border-gray-400 mt-6 pt-6">
          ...
          <div class="mt-4 flex">
            <div class="w-9/12 h-2 rounded-md rounded-r-none bg-teal-700"></div>
            <div class="w-1/12 h-2 bg-red-600"></div>
            <div class="w-1/12 h-2 bg-yellow-400"></div>
            <div
              class="w-1/12 h-2 rounded-md rounded-l-none bg-purple-700"
            ></div>
          </div>
          <ul class="mt-2 flex flex-wrap items-center text-xs">
    ...
    >
      ...
      <div class="mx-16 hidden lg:block">
        <a href="#">
          <svg
            class="w-6 fill-current text-gray-400 hover:text-gray-600"
            viewBox="0 0 16 16"
            aria-hidden="true"
          >
            <path
